...
declare const Typography: import("react").ForwardRefExoticComponent<(Omit<import("react").ClassAttributes<HTMLElement> & import("react").HTMLAttributes<HTMLElement> & {
    variant: (typeof elements)[number];
}, "ref"> | Omit<import("react").ClassAttributes<HTMLHeadingElement> & import("react").HTMLAttributes<HTMLHeadingElement> & {
    variant: (typeof elements)[number];
