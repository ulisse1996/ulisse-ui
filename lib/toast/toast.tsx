...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      'absolute right-2 top-2 rounded-md p-1 text-card-foreground/50 opacity-100 transition-opacity hover:text-card-foreground focus:outline-none focus:ring-2 group-hover:opacity-100',
